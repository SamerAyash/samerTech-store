        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                <div class="d-flex align-items-center flex-wrap mr-2">
                    <h5 class="text-dark font-weight-bold my-1 mr-5 post-form-subheader-title">Create Post</h5>
                ...
                <form action="{{ route('admin.posts.store') }}" method="POST" enctype="multipart/form-data" id="postForm">
                    ...
                    <div class="card card-custom mb-5">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <textarea name="en_content" id="en_content" style="display: none;" class="@error('en_content') is-invalid @enderror">{{ old('en_content') }}</textarea>
                                @error('en_content')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <textarea name="ar_content" id="ar_content" style="display: none;" class="@error('ar_content') is-invalid @enderror">{{ old('ar_content') }}</textarea>
                                @error('ar_content')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <textarea name="en_excerpt" 
                                          ...
                                          rows="3"
                                          placeholder="Enter excerpt (EN)">{{ old('en_excerpt') }}</textarea>
                                @error('en_excerpt')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <textarea name="ar_excerpt" 
                                          ...
                                          rows="3"
                                          placeholder="Enter excerpt (AR)">{{ old('ar_excerpt') }}</textarea>
                                @error('ar_excerpt')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="en_meta_description" 
                                                  ...
                                                  rows="3"
                                                  placeholder="Enter meta description (EN)">{{ old('en_meta_description') }}</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="ar_meta_description" 
                                                  ...
                                                  rows="3"
                                                  placeholder="Enter meta description (AR)">{{ old('ar_meta_description') }}</textarea>
                    ...
                    <div class="card-footer post-form-footer d-flex justify-content-end">
                        <button type="submit" class="btn btn-primary font-weight-bold mr-2">
                            <i class="flaticon2-paperplane"></i> Create Post
                        </button>
