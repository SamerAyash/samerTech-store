...
<div class="login-form">
    <form class="form fv-plugins-bootstrap fv-plugins-framework" id="kt_login_forgot_form" action="{{route('admin.resetPassword')}}" method="post" novalidate="novalidate">
        @csrf
        <!--begin::Title-->
        ...
        <div class="form-group d-flex flex-wrap">
            ...
            <a href="{{route('admin.login')}}" id="kt_login_forgot_cancel" class="btn btn-dark font-weight-bolder font-size-h6 px-8 py-4 my-3">Cancel</a>
        </div>
        <!--end::Form group-->
