        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                <div class="d-flex align-items-center flex-wrap mr-2">
                    <h5 class="text-dark font-weight-bold my-1 mr-5 category-form-subheader-title">Edit Category</h5>
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm category-form-breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <span class="text-muted d-none d-sm-inline">{{ $category->name }}</span>
                    ...
                    <form action="{{ route('admin.categories.update', $category) }}" method="POST">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       name="en_name" 
                                       value="{{ old('en_name', optional($category->translate('en'))->name) }}" 
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       name="ar_name" 
                                       value="{{ old('ar_name', optional($category->translate('ar'))->name) }}" 
                                ...
                                <div class="checkbox-inline">
                                    <label class="checkbox checkbox-lg">
                                        <input type="checkbox" 
                                               name="active_navbar" 
                                               value="1"
                                               {{ old('active_navbar', $category->active_navbar) == 1 ? 'checked' : '' }}>
                                        <span></span>
                                        Display in Navbar
                                    </label>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="parent_id" 
                                    ...
                                    @foreach ($parents as $parent)
                                        <option value="{{ $parent->id }}" 
                                            ...
                                            {{ optional($parent->translate('en'))->name }}
                                        </option>
                                    @endforeach
                                </select>
                                <span class="form-text text-muted">
                                    ...
                                    @if($category->children()->count() > 0)
                                        <span class="text-primary d-block mt-1">This category has {{ $category->children()->count() }} child category(ies).</span>
                                    @endif
                                </span>
                                @error('parent_id')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                        ...
                        <div class="card-footer category-form-footer d-flex justify-content-end">
                            <button type="submit" class="btn btn-primary font-weight-bold mr-2">
                                <i class="flaticon2-check-mark"></i> Update
                            </button>
